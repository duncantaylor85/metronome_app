class BeatSequenceTimeRepresentation {
    ...
    /**
     * 
     * @param {Number} barCount the number of times to replicate the first bar-worth of beats of the BSTR
    ...
    addCountIn(barCount) {
        ...
        let fullCountIn = this.repeatArray(barCount, countInBar)
    ...
    getFirstBarCountIn() {
        ...
        return this.beats
            .filter(beat => beat.associatedBarNumber === 1)
            .map(beat => new BeatTimeRepresentation(beat.durationInMillis, true, beat.isFirstBeatOfBar, beat.associatedBarNumber))
    }
