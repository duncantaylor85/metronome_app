...
class BarSequence {
    ...
    getTimeSigOf(barNum) {
        return this.bars[barNum - 1].getTimeSig()
    }
    getTempoOf(barNum) {
...
const BasicDuration = {
    ...
    fromInteger(i) {
        ...
        switch (i) {
            case 1: return BasicDuration._1st;
            case 2: return BasicDuration._2nd;
            case 4: return BasicDuration._4th;
            case 8: return BasicDuration._8th;
            case 16: return BasicDuration._16th;
            case 32: return BasicDuration._32nd;
