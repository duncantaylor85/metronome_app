...
function setupMenuButtons(menuComponent) {
    ...
    const menuButtonsToLoad = [
      ...
      initialiseMenuButtons("Edit", "edit", "mdi-pencil", menuComponent.editBar, null),
      initialiseMenuButtons(
        "Delete",
        "delete",
        "mdi-minus-circle",
...
function selectDefaultTab(menuComponent) {
    ...
    menuComponent.menuData.subButtonStatus = menuComponent.menuData.menuButtons[defaultButton].subButtonStatus
}

function assignSubButtonStatus(visibility, icon, executeFunction, noBarsBehaviour) {
    return {
      visibility,
      icon,
      executeFunction,
...
function initialiseMenuButtons(label, mode, subButtonIcon, subButtonExecuteFunction, subButtonNoBarsBehaviour) {
    return {
      label,
      mode,
